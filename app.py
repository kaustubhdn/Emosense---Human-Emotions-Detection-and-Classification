...
pipeline = pickle.load(open("Youtube_live_stream_sentiment_dashbording-main/stacking_model.pkl", "rb"))
...
# Set up your API key
API_KEY = 'AIzaSyDqDENpoVxkIiLR5pJFPMOZDUPGp9jlAsM'
...
st.sidebar.image("Youtube_live_stream_sentiment_dashbording-main/youtube-5702871_1280-removebg-preview.png", use_container_width=True)
